...
public class LessonController {
    ...
    public ResponseEntity<List<LessonModel>> getAllLessonsFromAModule(@PathVariable(value = "moduleId") UUID moduleId){
        return ResponseEntity.status(HttpStatus.OK).body(lessonService.findAllLessonsByModule(moduleId));
    }
